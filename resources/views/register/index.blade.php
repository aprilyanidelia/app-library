    ...
    <div class="row vh-100 g-0">
      ...
      <div class="col-lg-6">
        <div class="row align-items-center justify-content-center h-100 g-0 px-4 px-sm-0">
          ...
          <div class="form-floating mb-3">
              <input type="text" name="nm_lengkap" id="floatingInput" class="form-control @error('nm_lengkap') is-invalid @enderror" autofocus required value="{{old('nm_lengkap')}}" placeholder="Full name">
              @error('nm_lengkap')
              <div class="invalid-feedback">
                  {{$message}}
              </div>
          ...
          <div class="form-floating mb-3">
              <input type="email" name="email" id="floatingInput" class="form-control @error('email') is-invalid @enderror" autofocus required value="{{old('email')}}" placeholder="Email">
              @error('email')
              <div class="invalid-feedback">
                  {{$message}}
              </div>
          ...
          <div class="form-floating mb-3">
              <input type="text" name="alamat" id="floatingInput" class="form-control @error('alamat') is-invalid @enderror" autofocus required value="{{old('alamat')}}" placeholder="Address">
              @error('alamat')
              <div class="invalid-feedback">
                  {{$message}}
              </div>
